...
const base: LocaleMessages<DefaultLocaleMessageSchema> = {
  ...
  projects: {
    ...
    IPInbound: { name: 'IP Inbound' },
    claudeMonitor: { name: 'Claude Monitor' },
    swiftAirmen: { name: 'SwiftAirmen' },
    swiftNMEA: { name: 'SwiftNMEA' },
    approachVisualizer: { name: 'Approach Visualizer' },
    streamingCSV: { name: 'StreamingCSV' },
    streamingLZMA: { name: 'StreamingLZMA' },
    swiftCIFP: { name: 'SwiftCIFP' },

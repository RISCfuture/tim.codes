...
const en: LocaleMessages<DefaultLocaleMessageSchema> = {
  ...
  projects: {
    ...
    garminACE: {
      description: 'Swift parser for .ace files from the Garmin Aviation Checklist Editor',
      achievements: [
        'Round-trip encoding and decoding of Garmin checklist files',
        'Codable model schema for re-serializing checklists to JSON or other formats',
      ],
    },
    approachVisualizer: {
